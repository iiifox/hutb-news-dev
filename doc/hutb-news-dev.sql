...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='运营管理平台的admin级别用户';
...
VALUES ('1001', 'admin', '$2a$10$c8Eh/a7NAwtOLOs/S4Kd9ufGaTFzBszfOuaRDhc09nl59HQWBNjpG', NULL, 'admin',
        '2022-07-09 1:33:39', '2022-07-09 1:33:44');
COMMIT;
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='网站用户';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='文章资讯表';
...
(
  ...
  AUTO_INCREMENT = 14
  DEFAULT CHARSET = utf8mb4 COMMENT ='新闻资讯文章的分类（或者称之为领域）';
