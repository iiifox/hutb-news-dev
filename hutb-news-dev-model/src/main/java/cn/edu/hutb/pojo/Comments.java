...
public class Comments {
     ...
     * 获取评论的文章是哪个作者的关联id
     *
     * @return writerId - 评论的文章是哪个作者的关联id
     */
     ...
     *
     * @return fatherId - 如果是回复留言，则本条为子留言，需要关联查询
     */
     ...
     *
     * @return articleTitle - 冗余文章标题，宽表处理，非规范化的sql思维，对于几百万文章和几百万评论的关联查询来讲，性能肯定不行，所以做宽表处理，从业务角度来说，文章发布以后不能随便修改标题和封面的
     */
     ...
     * 获取发布留言的用户id
     *
     * @return commentUserId - 发布留言的用户id
     */
     ...
     *
     * @return commentUserNickname - 冗余用户昵称，非一致性字段，用户修改昵称后可以不用同步
     */
     ...
     * 获取冗余的用户头像
     *
     * @return commentUserFace - 冗余的用户头像
     */
